...
@section('header')
	...
	<ol class="breadcrumb">
		...
		<li><a href="{{ route('owner.transaction.index') }}">REKBER</a></li>
		<li class="active">Detail REKBER</li>
	</ol>
@endsection
		...
		<div class="col-md-12">
			<div class="box box-danger">
			                    ...
			                    <div class="col-md-6">
			                        <p>
										...
										@elseif( $data->status_payment == \App\Models\Transaction::STATUS_PAYMENT_PENDING )
											<span class="label label-warning">waiting payment verification from admin</span>
			                    ...
			                    <div class="col-md-6">
			                        <p>
			                           	@if( $data->status == \App\Models\Transaction::STATUS_PENDING )
											<span class="label label-default">Waiting Verify</span>
										...
										@else
											<span class="label label-primary">Waiting Payment Confirmation</span>
										@endif
			                        </p>
			                    </div>
			                </div>
		        ...
		        <div class="box-footer">
		        	...
		        	@elseif( $data->status == \App\Models\Transaction::STATUS_VERIFIED && $data->status_payment != \App\Models\Transaction::STATUS_PAYMENT_VERIFIED )
            ...
            <div class="modal-content">
                <form action="#" method="post" id="formVerify">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">REKBER Verify</h4>
                    </div>

                    <div class="modal-body">
                        <p>Would you verify this REKBER ?</p>
            ...
            <div class="modal-content">
                <form action="#" method="post" id="formReject">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">REKBER Reject</h4>
                    </div>

                    <div class="modal-body">
                        <p>Would you reject this REKBER ?</p>
                        <textarea name="note" class="form-control" placeholder="Note" required></textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">
            ...
            <div class="modal-content">
                <form action="#" method="post" id="formCancel">
                    ...
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title">REKBER Cancel</h4>
                    </div>

                    <div class="modal-body">
                        <p>Would you cancel this REKBER ?</p>
                        <textarea name="note" class="form-control" placeholder="Note" required></textarea>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default pull-left" data-dismiss="modal">
	...
	<script>
        jQuery(document).ready(function($){
	        ...
	        $('#formCancel').submit(function (event) {
                ...
                $.ajax({
                    url: "{{ route('owner.transaction.cancel') }}",
                    type: 'POST',
                    data: _data,
                    dataType: 'json',
                    cache: false,
	        ...
	        $('#formVerify').submit(function (event) {
                ...
                $.ajax({
                    url: "{{ route('owner.transaction.verify') }}",
                    type: 'POST',
                    data: _data,
                    dataType: 'json',
                    cache: false,
	        ...
	        $('#formReject').submit(function (event) {
                ...
                $.ajax({
                    url: "{{ route('owner.transaction.reject') }}",
                    type: 'POST',
                    data: _data,
                    dataType: 'json',
                    cache: false,
