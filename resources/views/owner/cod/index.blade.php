...
@section('content')
	<div class="box box-danger">
        <div class="box-header with-border">
        	<h3 class="box-title"><i class="fa fa-circle-o"></i> COD</h3>
        </div>
        ...
        jQuery(document).ready(function($){
            ...
            var table = $('#cod_table').DataTable({
                ...
                "columns": [
                    ...
                    {
                        render : function(data, type, row){
                            if( row.status == '{{ App\Models\Booking::STATUS_CANCELED }}' )
                    ...
                    {
                        render : function(data, type, row){
                        	return	'<a href="{{ route('owner.cod.index') }}' + "/" + row.id + '" class="view-btn btn btn-xs btn-primary"><i class="fa fa-eye"> view</i></a>';
                        },
                        "width": "10%",
                        "orderable": false,
                    }
