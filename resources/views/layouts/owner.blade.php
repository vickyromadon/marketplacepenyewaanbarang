...
<body class="hold-transition skin-red fixed sidebar-mini">
  ...
  <!-- Logo -->
  <a href="{{ route('owner.home.index') }}" class="logo">
    <!-- mini logo for sidebar mini 50x50 pixels -->
    <span class="logo-mini"><b>O</b>RC</span>
    <!-- logo for regular state and mobile devices -->
    <span class="logo-lg"><b>Owner</b>ROC</span>
  </a>
  ...
  <nav class="navbar navbar-static-top" role="navigation">
        ...
        <li class="dropdown user user-menu">
          ...
          <ul class="dropdown-menu">
            ...
            <li class="user-footer">
              <div class="pull-left">
                <a href="{{ route('owner.home.profile', ['id' => Auth::user()->id]) }}" class="btn btn-default btn-flat">Profile</a>
              </div>
    ...
    <section class="sidebar">
      ...
      <!-- Sidebar Menu -->
      {!! $MenuOwner->asUl( ['class' => 'sidebar-menu', 'data-widget' => 'tree'] ) !!}
      <!-- /.sidebar-menu -->
    </section>
    <!-- /.sidebar -->
    </aside>
  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <script src="{{ mix('/js/dropzone.min.js') }}"></script>
    ...
    <script type="text/javascript">
      jQuery(document).ready(function($) {
        ...
        $('#bookingOwner').text('{{ count($bookingOwner) }}');
        $('#transactionRekberOwner').text('{{ count($transactionRekberOwner) }}');
        $('#deliveryOwner').text('{{ count($deliveryOwner) }}');
        $('#reversionOwner').text('{{ count($reversionOwner) }}');
        $('#refundOwner').text('{{ count($refundOwner) }}');
        $('#transactionCodOwner').text('{{ count($transactionCodOwner) }}');
      });
    </script>
