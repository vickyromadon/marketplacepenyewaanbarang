		...
		<div class="col-md-4">
			<div class="box box-warning">
				...
				<div class="box-footer">
					<a href="{{ route('members.index') }}" class="btn btn-warning"><i class="fa fa-mail-reply"></i> Back</a>
	...
	<script>
        jQuery(document).ready(function($){
	        ...
	        $('#btnNotActive').click(function () {
                $('#formStatus')[0].reset();
                $('#formStatus .modal-title').text("Not Active Member");
                $('#formStatus #info').text("Are you sure you want to Not Active Member");
