...
<table width="600" cellpadding="10" cellspacing="0" border="0" align="center" bgcolor="#ffffff" class="boxshadow">
    ...
    <tr height="20" align="center">
        <td colspan="30">
            ...
            <h5 style=" font-family:Tahoma, Geneva, sans-serif; line-height: 16px; font-size: 12px; color:#000; font-weight: 500;">
                Product yang Akan di Kembalikan Sudah di Kirim Alamat Yang Tertera.
            </h5>
        </td>
    </tr>
        ...
        <td style="padding: 0 30px;">
            <h5 style=" font-family:Tahoma, Geneva, sans-serif; line-height: 16px; font-size: 12px; color:#000; font-weight: 500;">
                ...
                <b>Nama</b>             : {{ $reversion->name }} <br>
                <b>Phone</b>            : {{ $reversion->phone }} <br>
                <b>Address</b>          : {{ $reversion->address }} <br> <br>

                <b>Tanggal Dikirim</b>  : {{ $reversion->delivery_date }} <br>
                <b>Tanggal Tiba</b>     : {{ $reversion->arrive_date }} <br>
            </h5>
        </td>
    </tr>
    <tr height="0" align="center">
    ...
    <tr align="center">
        <td colspan="30">
            <a href="{{ route('owner.reversion.show', ['id' => $reversion->id]) }}" class="button">CONFIRM REVERSION</a>
        </td>
    </tr>
</table>
</body>
