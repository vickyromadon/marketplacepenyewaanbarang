...
<table width="600" cellpadding="10" cellspacing="0" border="0" align="center" bgcolor="#ffffff" class="boxshadow">
    ...
    <tr height="20" align="center">
        <td colspan="30">
            ...
            <h5 style=" font-family:Tahoma, Geneva, sans-serif; line-height: 16px; font-size: 12px; color:#000; font-weight: 500;">
                Payment Confirmation Atas Nama Member "{{ $member->name }}", <br>Sudah Kami Terima dan Verifikasi.
            </h5>
        </td>
    </tr>
    ...
    <tr align="center">
        <td colspan="30">
            <a href="{{ route('owner.transaction.show', ['id' => $transaction->id]) }}" class="button">VIEW Transaction</a>
        </td>
    </tr>
</table>
</body>
