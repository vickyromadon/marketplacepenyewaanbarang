...
<table width="600" cellpadding="10" cellspacing="0" border="0" align="center" bgcolor="#ffffff" class="boxshadow">
    ...
    <tr height="20" align="center">
        <td colspan="30">
            ...
            <h5 style=" font-family:Tahoma, Geneva, sans-serif; line-height: 16px; font-size: 12px; color:#000; font-weight: 500;">
                Anda memiliki 1 Product Booking Untuk di Tanggapi.
            </h5>
        </td>
    </tr>
        ...
        <td style="padding: 0 30px;">
            <h5 style=" font-family:Tahoma, Geneva, sans-serif; line-height: 16px; font-size: 12px; color:#000; font-weight: 500;">
                ...
                <b>Member Name</b>     : {{ $member->name }} <br>
    ...
    <tr align="center">
        <td colspan="30">
            <a href="{{ route('owner.booking.show', ['id' => $booking->id]) }}" class="button">CONFIRM BOOKING</a>
        </td>
    </tr>
</table>
</body>
