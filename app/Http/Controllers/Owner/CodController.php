...
class CodController extends Controller
{
    public function index(Request $request)
    {
    	if( $request->isMethod('post') ){
            ...
            $total = DB::table('transactions')->join('bookings', 'transactions.booking_id', '=', 'bookings.id')
                        ...
                        ->where('transactions.payment_method', '=', Transaction::METHODE_PAYMENT_COD)
    ...
    public function verify(Request $request)
    {
        ...
        return response()->json([
            'success'  => true,
            'message'  => 'COD Successfully Approved'
        ]);
    }
    ...
    public function reject(Request $request)
    {
        ...
        return response()->json([
            'success'  => true,
            'message'  => 'COD Successfully Rejected'
        ]);
    }
    ...
    public function cancel(Request $request)
    {
        ...
        return response()->json([
            'success'  => true,
            'message'  => 'COD Successfully Canceled'
        ]);
    }
}
